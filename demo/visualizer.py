...
class AVAVisualizer(object):
    ...
    def __init__(
        ...
        self.cls2label = {class_name: i for i, class_name in enumerate(self.CATEGORIES)}
        if exclude_class is None:
            exclude_class = self.EXCLUSION
        self.exclude_id = [self.cls2label[cls_name.lower()] for cls_name in exclude_class]
